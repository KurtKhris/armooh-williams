...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="bg-brand-ivory relative overflow-hidden section-padding">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-coral-500/8 border border-coral-500/15 mb-5">
              ...
              <p className="text-brand-dark/60 font-body text-base max-w-md mx-auto">
