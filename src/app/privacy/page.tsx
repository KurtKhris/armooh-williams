...
export const metadata: Metadata = {
  title: "Privacy Policy | Armooh-Williams, PLLC",
  description: "Privacy Policy for Armooh-Williams, PLLC",
};

async function getPage() {
  try {
    const [page] = await db.select().from(legalPages).where(eq(legalPages.type, "privacy"));
    return page ?? null;
  } catch {
    return null;
  }
