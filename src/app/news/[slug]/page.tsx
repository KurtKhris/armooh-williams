    ...
    <>
      ...
      <main>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-4 gap-10">
              <article className="lg:col-span-3 prose prose-lg max-w-none font-body text-brand-dark/80 leading-relaxed">
                <div 
                  className="whitespace-pre-wrap font-body text-brand-dark/75 leading-[1.85] text-base prose-p:mb-4 prose-a:text-coral-500 hover:prose-a:text-coral-600 prose-headings:text-brand-dark prose-headings:font-heading prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl"
        ...
        <section className="py-10 bg-brand-gray/30 border-t border-brand-gray">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Link href="/news" className="inline-flex items-center gap-2 text-teal-800 hover:text-coral-500 font-body font-semibold text-sm transition-colors">
