...
export const metadata: Metadata = {
  ...
  description: "Expert legal insights, analysis, and updates from Armooh-Williams, PLLC attorneys.",
};
      ...
      <main>
        ...
        <section className="pt-32 pb-16 gradient-hero">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="font-heading text-5xl sm:text-6xl font-semibold text-white mb-5">
              Our Legal <span className="text-coral-500">Blog</span>
            </h1>
        ...
        {allPosts.length === 0 ? (
          <section className="py-24 bg-white text-center">
            ...
            <p className="font-body text-brand-dark/55 text-sm">Check back soon for legal insights and updates.</p>
          </section>
        ) : (
